...
<?php
      ...
      $Address = $_POST['Address'];
		...
		$sql = "INSERT INTO allsector (Name,UName,Email,Pass,phone,Sector,SectorEmail,Address) VALUES
		('{$_POST["Name"]}','{$_POST["UName"]}','{$_POST["Email"]}','{$_POST["Pass"]}','{$_POST["Phone"]}','{$_POST["Sector"]}','{$_POST["SectorEmail"]}','{$_POST["Address"]}')";
			if(mysqli_query($conn, $sql) == TRUE){
			...
			}else{
				{
					...
					<div class="alert alert-danger">
					  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
					  <strong>Fail!</strong> Your has been Not Inserted.
					</div>';
				  }
			}
		}
...
<div class="page">
          ...
          <label for="Name">Admin Name<span class="required-field">*</span></label>
          <input type="text" class="form-control" placeholder="Enter Your Name" name="Name" required>
      </div> 
	  <div class="form-group">
          <label for="UName">Admin Username<span class="required-field">*</span></label>
      ...
      <div class="form-group">
          <label for="Email">Sector Email<span class="required-field">*</span></label>
          <input type="text" class="form-control" placeholder="Enter Sector Email" name="SectorEmail" required>
      </div> 

	  <div class="form-group">
          <label for="Email">Admin Email<span class="required-field">*</span></label>
          <input type="text" class="form-control" placeholder="Enter Email" name="Email" required>
      </div> 

	  <div class="form-group">
          <label for="Phone">Admin Mobile No<span class="required-field">*</span></label>
	  ...
	  <div class="form-group">
          <label for="Pass">Admin Password<span class="required-field">*</span></label>
