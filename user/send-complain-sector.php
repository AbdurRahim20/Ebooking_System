...
if(isset($_POST["submit"]))
{
    ...
    $sql="INSERT INTO feedback(Name,Email,Sector,Subject,Message) VALUES('{$_POST["Name"]}','{$_POST["Email"]}','{$_POST["Sector"]}','{$_POST["Subject"]}','{$_POST["Message"]}')"; 
...
<form action="" method="POST">
	  ...
	  <div class="form-group ">
      <label for="Sector"><b>Type of Company</b></label>
