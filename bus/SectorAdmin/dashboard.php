			...
			<div class="sidebar-scroll">
				<nav>
					...
					<li><a href="dashboard.php"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
						<li><a href="bus.php"><i class="lnr lnr-plus-circle"></i> <span>Add New Bus</span></a></li>
						...
						<li><a href="bus_reserve.php"><i class="lnr lnr-sync"></i> <span>Reservation Request</span></a></li>
