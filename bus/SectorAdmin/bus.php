    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-body">
            <form action="" method="post">
                ...
                <input class="btn btn-success" type="submit" value="Add Bus" name='submit'>   
                <button type="reset" class="btn btn-danger" data-dismiss="modal" > Close</button>                
            </form>
            </div>
        </div>
...
if (isset($_POST['submit'])) {
    ...
    $sql="INSERT INTO bus(Name,BusNo,Type,Seat,Start,End,Price,S_Point,End_Point)
    VALUES('{$_POST["Name"]}','{$_POST["BusNo"]}','{$_POST["Type"]}','{$_POST["Seat"]}','{$_POST["Start"]}',
...
if (isset($_POST['edit'])) {
    ...
    $Price = $_POST['Price'];
            ...
            $sql="UPDATE bus SET Name='$Name',BusNo='$BusNo', Type='$Type', Seat='$Seat', Start='$Start', 
