...
<body>
	<div id="wrapper">
		<nav class="navbar navbar-default navbar-fixed-top" style="background-color:#13285a">
			...
			<div class="container-fluid">
				...
				<div id="navbar-menu">
                    ...
                    <li><a href="#" style="color:white"><i class="lnr lnr-user"></i> <span><?php echo $_SESSION["UName"]; ?></span></a></li>
					<li><a href="logout.php" style="color:white" data-toggle="modal" data-target="#logout"><i class="lnr lnr-exit"></i> <span>Logout</span></a></li>	
		...
		<div id="sidebar-nav" class="sidebar" style="background-color:#13285a">
				...
				<div class="container-fluid">
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title"><b>Welcome <?php echo $_SESSION["UName"]; ?> Dashboard</b></h3>
						</div>
