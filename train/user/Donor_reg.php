						...
						<div class="form-group">
						 ...
						 <div class="form-group">
						  ...
						  <div class="form-group">
                                ...
                                <input type="text" name="PINCODE" id="PINCODE" class="form-control" placeholder="Insert Pincode">
                          </div>
						   ...
						   <div class="form-group">
                                ...
                                <input type="text"  name="CONTACT_1" id="CONTACT_1" class="form-control" placeholder="Contact No-1">
                          </div>
						   <div class="form-group">
