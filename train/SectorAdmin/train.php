...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mt-4">
                <div class="card-header text-center text-white" style="background-color:#1747b6">
        ...
        <div class="row">
            ...
            <thead class=" text-white" style="background-color:#03a761">
                <tr>
                    <th>S.N</th>
                    <th>Train No</th>
                    <th>Train Name</th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header text-white text-center" style="background-color:#8d16bd"> 
                    ...
                    <div class="modal-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                            <button class="btn btn-success" type="submit" name='edit'> Edit Train</button>
...
<div class="modal fade" id="add">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" align="center">
            <div class="modal-header text-white" style="background-color:#df2f6f">
